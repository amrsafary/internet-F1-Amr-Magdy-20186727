<div id="plink"><div style="position:relative;z-index:1">          
          <a href="http://satanic-road.net//index.php">Register</a></div></div><div style="float:right;height:0;position:relative;bottom:27px;right:6px;">
</div>
	...
	if(isset($_SESSION['loggedin'])) {
		header("location:?news");
							...
							{
								echo "<div class='error'>This Nick Name has already been used.</div>";
							}
							else
							{
								...
								{
									echo "<div class='ok'>Registration is successful.</div>";
								}
								else
								{
